...
<div class="container banner">
 ...
 <center><a class="alert alert-danger" id="important" href="">ATENÇÃO LEIA !</a><br><bR> <a class="btn btn-success" id="abrir_modal_process" href="">Procedimentos para Acessar <br> os Videos </a></center>
    ...
    <div class="modal_process">
      <center><a class="btn btn-danger"  id="fechar_modal_process" href="">fechar</a></center>
      <div class="div_modal_video">        
      
   <iframe id="iframe_"  class="img-fluid"   src="https://www.youtube.com/embed/LnnXVxcHkgA" frameborder="0"  allowfullscreen></iframe>
 ...
 <div class="container-fluid cursos">
  ...
  <?php
   ...
   if(!in_array('avancado', $privilegio)){
            ?>
<div class="col-sm-4">
    <a href="<?php echo BASE_URL;  ?>Modulo_Avancado/entrar/<?php echo 1 ;?>"><div class="img_curso">
   ...
   <div style="cursor: pointer;" class="img_curso">
        ...
        <div>
          <?php echo $curso['nome'];  ?>
          <strong style="color: #dd9999"><p>seja Vip para desbloquear as aulas</p></strong>
        </div>
      </div>     
    </div>
  ...
  <?php endforeach;
    ...
    <div class="col-sm-4">
    <a href="<?php echo BASE_URL;?>Modulo_Avancado/entrar/<?php echo $curso['id'];?>">
