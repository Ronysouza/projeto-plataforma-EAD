...
<div class="container banner">
 ...
 <div class="sub_titulo">
       ...
       <a class="btn btn-success" target="_blank" href="">Download dos Programas </a>
   	...
   	<div class="fechar ">   		   			
  		...
  		<div class="nome_modulo">
               <?php if(isset($aulas_modulo_iniciante[0]['nome_modulo'])){
               	?>
          <h2  ><?php echo $aulas_modulo_iniciante[0]['nome_modulo']; ?></h2>
             <?php
               }else{
                  ?>
               <h2  ><?php echo $video_aulas[0]['nome_modulo']; ?></h2>
               <?php
           } ?>
 		...
 		<div style="margin: 10px;"><strong><?php  if(!isset($video_aulas[0]['descricao'])){
                 echo "Area de Alunos";
 		}else{

             ?> <strong style="color: #dd9999">Voçê está assistindo aula:</strong>  <?php echo $video_aulas[0]['descricao'];
 		} ?></strong></div>
  ...
  <div style="border-radius: 10px; height: 500px;" class="banner_princ">
 	...
 	<div class="banner_video">
         ...
         <?php if(!isset($video_aulas[0]['url'])){
   ...
   <iframe style="border: 0;padding: 0;"  src="https://www.youtube.com/embed/<?php echo $video_aulas[0]['url']; ?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
  ...
  <div class="banner_menu">
             ...
             <?php
              if(isset($aulas_modulo_iniciante[0]['id'])){
              	if(!isset($video_aulas[0]['descricao'])){
              		?>
                  <p style="background-color: #dd9999">Conteúdo do Curso</p>
                  <?php
              	}else{
              		?>
           <p style="background-color: #ddee99">  <strong style="color: #dd9999">Voçê está assistindo aula: </strong><?php  echo $video_aulas[0]['descricao'];?></p>
              		<?php
              	}
             	?>
                 
	
		<?php foreach( $aulas_modulo_iniciante as $aulas): ?>
		 <a href="<?php echo BASE_URL; ?>ModuloIniciante/aula_modulo_iniciante/<?php echo $aulas['id']; ?>"><p><?php echo $aulas['titulo']; ?></p></a>
           <?php endforeach;  ?>
              <?php
             }?>    
